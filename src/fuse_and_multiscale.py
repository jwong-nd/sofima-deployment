...
from pipeline import zarr_io, zarr_register_and_fuse
from pipeline.zarr_multiscale import run_multiscale
...
def main(): 
    ...
    zd = zarr_io.DiSpimDataset(cloud_storage, 
                            ...
                            downsample_exp)
    zarr_stitcher = zarr_register_and_fuse.ZarrStitcher(zd)
